...
| Value | Encoding |
|-------|----------|
| `4` | **UTF-8** (recommended) — Universal Unicode support |
| `30` | Mac Roman — Legacy Mac encoding |
| `5` | ISO Latin-1 — Western European |
| `21` | ASCII — Basic US characters only |

## Our Configuration

**Set to**: `4` (UTF-8) — Universal character support.

### Why UTF-8?

1. **International support** — All languages and scripts
2. **Emoji** — Full emoji support in terminal
3. **Modern standard** — What all modern systems expect
4. **Git compatibility** — UTF-8 filenames work correctly
5. **Programming** — Unicode strings in source code
...
**Terminal** → **Settings** (⌘,) → **Profiles** → [Profile Name] → **Advanced** → **Text encoding**
...
| Issue | Solution |
|-------|----------|
| Characters garbled | Check shell LANG/LC_ALL vars |
| Remote server issues | Configure SSH for UTF-8 |
| Settings not applying | Restart Terminal |
