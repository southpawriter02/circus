...
**File**: [`defaults/applications/archive_utility.sh`](../../../../defaults/applications/archive_utility.sh)

```bash
run_defaults "com.apple.archiveutility" "dearchive-move-after" "-string" "$HOME/.Trash"
run_defaults "com.apple.archiveutility" "dearchive-reveal-after" "-bool" "true"
```
