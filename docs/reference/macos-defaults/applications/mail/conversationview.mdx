...
All three set to `true` — Full conversation threading with newest first.
...
**View** menu:
- **Organize by Conversation** (⌃⌘O) — Enables/disables threading
- **Include Related Messages** — Shows messages from all mailboxes
- **Sort By** → **Date (Descending)** — Newest first

Also in **Mail** → **Settings** (⌘,) → **Viewing**
...
```
📧 RE: Project Update - Alice
📧 Quarterly Report - Bob  
📧 RE: RE: Project Update - Carol
📧 Project Update - You
📧 RE: Project Update - Alice
```
...
```
📧 Project Update (4 messages)
    └─ Carol: RE: RE: Project Update
    └─ Alice: RE: Project Update  
    └─ Alice: RE: Project Update
    └─ You: Project Update
...
- **Mail.app**: macOS 10.7 (Lion) and later
